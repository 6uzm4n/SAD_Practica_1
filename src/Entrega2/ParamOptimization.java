...
public class ParamOptimization {
	...
	public static void main(String[] args) throws IOException {
        ...
        if (args.length == 0) {
			...
			System.out.println(
					"Este programa tiene como funci�n obtener los par�metros �ptimos para el modelo Support Vector Machine.");
			System.out.println("Este programa necesita introducir 1 argumento para funcionar correctamente.");
			System.out.println(
					"PRECONDICIONES:\nEl primer y �nico argumento será el path del conjunto de entrenamiento que usaremos posteriormente");
			System.out.println(
	...
	/**
	 * Calcula los par�metros �ptimos para el modelo SVM y los imprime por pantalla
	 * 
	 * @param pInstances
	 * 			Instancias de entrenamiento que usaremos para hallar los par�metros �ptimos
	 */
