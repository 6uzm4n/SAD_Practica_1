...
public class MakeCompatible {
	...
	public static void main(String[] args) throws Exception {
		if (args.length == 0) {
			...
			System.out.println("Este programa tiene como función hacer que un conjunto de evaluación dado sea compatible " +
					"con un conjunto de entrenamiento dado.");
			System.out.println("Este programa necesita que introduzcas 3 argumentos para funcionar correctamente.");
			System.out.println("PRECONDICIONES:\nEl primer argumento será el path del diccionario. El segundo es el path" +
					" del conjunto de evaluación que se debe hacer compatible. El tercero será el path de la salida para" +
					" este nuevo conjunto de datos compatible");
